...
// define action id
enum {
	BLE_QIOT_ACTION_ID_LIGHT_BLINK,
	BLE_QIOT_ACTION_ID_BUTT,
};

// define action light_blink input id 
enum {
	BLE_QIOT_ACTION_LIGHT_BLINK_INPUT_ID_TIME,
	BLE_QIOT_ACTION_LIGHT_BLINK_INPUT_ID_COLOR,
	BLE_QIOT_ACTION_LIGHT_BLINK_INPUT_ID_TOTAL_TIME,
	BLE_QIOT_ACTION_LIGHT_BLINK_INPUT_ID_BUTT,
};

// define light_blink time attributes
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TIME_MIN	(0)
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TIME_MAX	(10)
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TIME_START	(0)
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TIME_STEP	(1)
// define light_blink total_time attributes
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TOTAL_TIME_MIN	(0)
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TOTAL_TIME_MAX	(100)
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TOTAL_TIME_START	(0)
#define BLE_QIOT_ACTION_INPUT_LIGHT_BLINK_TOTAL_TIME_STEP	(1)
// define action light_blink output id 
enum {
	BLE_QIOT_ACTION_LIGHT_BLINK_OUTPUT_ID_ERR_CODE,
	BLE_QIOT_ACTION_LIGHT_BLINK_OUTPUT_ID_BUTT,
};

// define light_blink err_code enum
enum {
	BLE_QIOT_ACTION_OUTPUT_LIGHT_BLINK_ERR_CODE_OK = 0,
	BLE_QIOT_ACTION_OUTPUT_LIGHT_BLINK_ERR_CODE_FAILED = 1,
	BLE_QIOT_ACTION_OUTPUT_LIGHT_BLINK_ERR_CODE_BUTT,
};

#define BLE_QIOT_ACTION_INPUT_ID_BUTT	3
