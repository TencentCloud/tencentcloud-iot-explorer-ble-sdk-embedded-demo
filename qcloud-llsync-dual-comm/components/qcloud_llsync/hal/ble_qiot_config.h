...
// choose the ability you used, set 1 with BLE_QIOT_LLSYNC_STANDARD and BLE_QIOT_LLSYNC_CONFIG_NET will enable dual-mode communication
...
#define BLE_QIOT_LOG_PRINT(...) printf(__VA_ARGS__)
    ...
    #define BLE_QIOT_RECORD_FLASH_ADDR 0xFE000
    #define BLE_QIOT_RECORD_FLASH_PAGESIZE  0x1000
